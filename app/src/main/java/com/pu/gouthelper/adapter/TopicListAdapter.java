...
public class TopicListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BitmapView.getInstance().display(topic_img_icon, entity.getUser().getAvatar());
        ...
        topic_tv_title.setText(entity.getTitle());
        ...
        for (String url : entity.getAttrs()) {
            ...
            imageView.setLayoutParams(new LinearLayout.LayoutParams(220, 210));
