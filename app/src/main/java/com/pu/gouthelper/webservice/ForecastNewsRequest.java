 ...
 * 发作记录文章
 */
public class ForecastNewsRequest extends BaseRequest {
    public static final int SUCCESS = 0x26;
    public static final int ERROR = 0x25;
    private Handler mHandler;

    /**
     * @param mHandler
     */
    public ForecastNewsRequest(Handler mHandler) {
        this.mHandler = mHandler;
        RequestParams params = new RequestParams(URLlist.URL_FORECAST_NEWS);
        sendGet(params);
    }
    ...
    public void onSuccessed(String result) {
        ...
        if (state == 1) {
            ...
            msg.obj = JSON.parseObject(object.getString("data"),ForecastNew.class);
            msg.what = SUCCESS;
