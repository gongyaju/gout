 ...
 * 删除提醒
 */
public class DelClockRequest extends BaseRequest {
    public static final int SUCCESS = 0x17;
     ...
     * @param   id:提醒ID
     */
    public DelClockRequest(Handler mHandler, String id) {
        this.mHandler = mHandler;
        RequestParams params = new RequestParams(URLlist.DEL_DRUG_CLOCK);
